...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_danny.weinberg/7c3fa8d5c40482cf9bff6a01c879a695/execroot/__main__',
    'ios_x86_64',
    {
        'watchos_i386': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/danny.weinberg/Library/Application Support/Tulsi/0.20190501.88/Bazel',
